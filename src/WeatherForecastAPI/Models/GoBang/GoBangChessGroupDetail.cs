...
namespace WeatherForecastAPI.Models.GoBang
{
    public class GoBangChessGroupDetail
    {
        ...
        public GoBangChessGroupDetail(GoBangChessGroupDefinition goBangChessGroupDefinition, List<GoBangChess> chesses, string direction)
        {
        ...
        public string ConvertToString()
        {
            ...
            {
                sb.Append($"{c.Position.Row:00}{c.Position.Column:00}{(int)c.Chess}");
            }

            return $"{GoBangChessGroupDefinition.DefinitionId:000}{Direction}{sb}";
        }

        public static GoBangChessGroupDetail? ConvertFromString(string s)
        {
                ...
                else
                {
                    ...
                    if (position == 4)
                    {
                        ...
                        GoBangChess goBangChess = new GoBangChess
                        {
                            ...
                            Chess = (GoBangChessType)chessType,
                        };
            ...
            return new GoBangChessGroupDetail(definition, chesses, direction);
        }
    }
}
